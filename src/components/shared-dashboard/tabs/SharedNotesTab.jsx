        ...
        <div className="flex items-start justify-between gap-2">
          ...
          {!isPrivateView && (
            <span className={`shrink-0 text-[10px] font-bold px-2.5 py-1 rounded-full border ${
              isOwn ? "bg-blue-50 text-blue-600 border-blue-200" : "bg-violet-50 text-violet-600 border-violet-200"
            }`}>
  ...
  return (
    <div className="w-full">
      ...
      {loading ? (
        ...
        <div className="grid grid-cols-2 gap-4 w-full" style={{ gridAutoRows: "1fr" }}>
  ...
  return (
    <div className="w-full min-h-full">
      <div className="mb-6">
        ...
        <p className="text-sm font-medium text-slate-500 mt-1">Manage shared resources and your private workspace</p>
      </div>
      ...
      <div className="flex items-center gap-1 bg-slate-100 rounded-xl p-1 mb-6 w-fit">
        <button onClick={() => setActiveView("shared")}
          className={`flex items-center gap-2 px-5 py-2.5 rounded-lg text-sm font-bold transition-all ${
            activeView === "shared" ? "bg-white text-blue-700 shadow-sm border border-blue-100" : "text-slate-500 hover:text-slate-700"
          }`}>
          <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round">
        ...
        <button onClick={() => setActiveView("private")}
          className={`flex items-center gap-2 px-5 py-2.5 rounded-lg text-sm font-bold transition-all ${
            activeView === "private" ? "bg-white text-amber-700 shadow-sm border border-amber-100" : "text-slate-500 hover:text-slate-700"
          }`}>
          <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round">
