...
            <span className="text-xs font-semibold text-slate-500">{formatDate(goal.startDate)}</span>
            <span className="text-xs font-semibold text-slate-500">{formatDate(goal.endDate)}</span>
          </div>
...
              />
            </div>
            <p className="text-xs text-slate-400 mt-1.5 text-right">{progress}% through engagement</p>
          </div>
