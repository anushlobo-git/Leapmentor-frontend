// src/components/mentor/dashboard/Sidebar.jsx
...
const NAV_ITEMS = [
  ...
  { key: "availability", label: "Availability", icon: <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><rect x="3" y="4" width="18" height="18" rx="2"/><line x1="16" y1="2" x2="16" y2="6"/><line x1="8" y1="2" x2="8" y2="6"/><line x1="3" y1="10" x2="21" y2="10"/></svg> },
  ...
  { key: "requests", label: "Requests", icon: <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M21 15a2 2 0 0 1-2 2H7l-4 4V5a2 2 0 0 1 2-2h14a2 2 0 0 1 2 2z"/></svg> },
  ...
  { key: "earnings", label: "Track Earnings", icon: <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><line x1="12" y1="1" x2="12" y2="23"/><path d="M17 5H9.5a3.5 3.5 0 0 0 0 7h5a3.5 3.5 0 0 1 0 7H6"/></svg> },
        ...
        return (
          <button
            ...
            style={{
              ...
              color: isActive ? "#1e3a8a" : "#64748b", transition: "all 0.15s",
            }}
          >
    ...
    <>
      ...
      <aside className="mentor-sidebar-drawer" style={{ position: "fixed", top: 0, left: 0, height: "100%", width: "224px", backgroundColor: "white", zIndex: 40, boxShadow: "0 25px 50px -12px rgba(0,0,0,0.25)", flexDirection: "column", transform: isOpen ? "translateX(0)" : "translateX(-100%)", transition: "transform 0.3s ease-in-out" }}>
        <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between", padding: "0 16px", height: "56px", borderBottom: "1px solid #f1f5f9", flexShrink: 0 }}>
          ...
          <button onClick={onClose} style={{ padding: "6px", borderRadius: "8px", border: "none", backgroundColor: "transparent", cursor: "pointer", color: "#94a3b8" }}>
