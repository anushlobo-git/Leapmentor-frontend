...
const SidebarContent = ({ navItems, activeTab, setActiveTab, onClose, unreadCount }: SidebarContentProps) => (
...
const DashboardSidebar = ({ navItems, activeTab, setActiveTab, isOpen, onClose, unreadCount = 0 }: DashboardSidebarProps) => {
  useEffect(() => {
