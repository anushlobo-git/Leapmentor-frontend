 ...
 * @param {(value: string) => void} props.onAdd
 * @param {(value: string) => void} props.onRemove
 * @param {string} [props.placeholder]
 * @param {boolean} [props.error]
 * @param {string} [props.inputId]
 */
const TagInput = ({ tags, onAdd, onRemove, placeholder, error, inputId }) => {
...
/**
 * @typedef {object} InterestedFieldsForm
 * @property {string[]} [interestedFields]
 * @property {string[]} [skills]
 */

/**
 * @typedef {object} InterestedFieldsErrors
 * @property {boolean} [interestedFields]
 ...
 *
 * @param {object} props
 * @param {InterestedFieldsForm} props.form
 * @param {(event: { target: { name: string, value: string[] } }) => void} props.handleChange
 * @param {InterestedFieldsErrors} [props.errors]
 */
const InterestedFieldsSection = forwardRef(
...
const interestedFieldsSectionPropTypes = {
...
Object.defineProperty(InterestedFieldsSection, "propTypes", {
  value: interestedFieldsSectionPropTypes,
});
