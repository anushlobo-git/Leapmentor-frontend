...
import type { HistoryRequest } from "@features/mentee/components/dashboard/history/DetailDrawer";
...
const SlotList = ({ slots, isConfirmed, title }: { slots: Slot[]; isConfirmed: boolean; title: string }) => (
  <div>
...
const UserMessageCard = ({ message }: { message?: string }) => {
...
// ── Slot row ────────────────────────────────────────────────
export const SlotRow = ({ slot, isConfirmed }: { slot: Slot; isConfirmed: boolean }) => (
  <div
...
// ── Pending content ─────────────────────────────────────────
export const PendingContent = ({ request, onDelete }: { request: HistoryRequest; onDelete: () => void }) => {
...
// ── Accepted content ────────────────────────────────────────
export const AcceptedContent = ({ request, onClose, onPayClick }: { request: HistoryRequest; onClose: () => void; onPayClick: () => void }) => {
...
// ── Completed content ───────────────────────────────────────
export const CompletedContent = ({ request, onClose }: { request: HistoryRequest; onClose: () => void }) => {
...
// ── Rejected content ────────────────────────────────────────
export const RejectedContent = ({ request, onClose }: { request: HistoryRequest; onClose: () => void }) => {
