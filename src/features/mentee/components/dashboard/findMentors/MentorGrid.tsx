...
import type { FindMentorsMentor } from "@features/mentee/components/dashboard/findMentors/MentorCard";
...
interface MentorGridProps {
  ...
  totalCount: number;
  onLoadMore: () => void;
  onViewProfile: (mentor: FindMentorsMentor) => void;
}

// ✅ Added onViewProfile prop — passed down to each MentorCard
const MentorGrid = ({ mentors, loading, loadingMore, hasMore, hasSearched, totalCount, onLoadMore, onViewProfile }: MentorGridProps) => {
