...
// ── Leap Points Panel ─────────────────────────────────────────
const LeapPointsPanel = ({ balance, loading }: LeapPointsPanelProps) => {
  const [requestStatus, setRequestStatus] = useState<string | null>(null); // null | "pending" | "sent" | "sending" | "error"
