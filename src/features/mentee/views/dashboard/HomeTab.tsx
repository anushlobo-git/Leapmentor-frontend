...
} from "@features/mentee/presenters/useHomeData";
import HomeMentorCard from "@features/mentee/views/dashboard/HomeMentorCard";
import LeapPointsPanel from "@features/mentee/views/dashboard/LeapPointsPanel";
...
const HomeTab = () => {
  ...
  const mentorsContent =
    mentors.length > 0 ? (
      mentors.map((mentor: FindMentorsMentor) => (
        <HomeMentorCard
