...
vi.mock("@features/connects/presenters/useConnectRequest", () => ({
  default: vi.fn(() => ({
    sending: false,
    error: null,
...
vi.mock("@features/sessions/presenters/useSlotLock", () => ({
  default: vi.fn(() => ({
...
vi.mock(
  "@features/mentee/views/dashboard/findMentors/ConnectSucessModal",
  () => ({
