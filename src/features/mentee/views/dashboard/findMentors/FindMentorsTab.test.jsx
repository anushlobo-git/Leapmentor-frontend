...
// Mock custom hook
vi.mock("@features/mentee/presenters/useMentorSearch", () => ({
  default: vi.fn(),
}));
...
// Mock sub-components
vi.mock("@features/mentee/views/dashboard/findMentors/SearchBar", () => ({
...
vi.mock(
  "@features/mentee/views/dashboard/findMentors/FilterPanel",
  () => ({
    default: () => <div data-testid="filter-panel">FilterPanel</div>,
  }),
);

vi.mock("@features/mentee/views/dashboard/findMentors/MentorGrid", () => ({
...
vi.mock(
  "@features/mentee/views/dashboard/findMentors/MentorProfileModal",
  () => ({
