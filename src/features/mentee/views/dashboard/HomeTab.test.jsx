...
vi.mock("@features/mentee/presenters/useHomeData", () => ({
  useHomeData: vi.fn(),
...
vi.mock("@features/mentee/views/dashboard/HomeMentorCard", () => ({
...
vi.mock("@features/mentee/views/dashboard/LeapPointsPanel", () => ({
  default: ({ balance }) => (
