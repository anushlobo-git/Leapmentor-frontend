...
vi.mock("@features/mentee/views/dashboard/history/StatusBadge", () => ({
  default: ({ status }) => <div data-testid="status-badge">{status}</div>,
}));

vi.mock(
  "@features/mentee/views/dashboard/history/EscrowPaymentModal",
  () => ({
...
vi.mock(
  "@features/mentee/views/dashboard/history/RequestStatusViews",
  () => ({
...
vi.mock(
  "@features/mentee/views/dashboard/history/OngoingReferredContent",
  () => ({
