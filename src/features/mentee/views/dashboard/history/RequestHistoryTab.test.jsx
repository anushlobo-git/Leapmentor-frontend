...
// Mock hooks
vi.mock("@features/mentee/presenters/useRequestHistory", () => ({
  default: vi.fn(),
}));
...
vi.mock("@features/mentee/views/dashboard/history/HistoryTable", () => ({
...
vi.mock("@features/mentee/views/dashboard/history/DetailDrawer", () => ({
