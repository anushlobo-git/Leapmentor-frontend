...
import useMenteeEditProfile from "@features/mentee/presenters/useMenteeEditProfile";
...
// Mock custom hook
vi.mock("@features/mentee/presenters/useMenteeEditProfile", () => ({
  default: vi.fn(),
}));

// Mock sub-components
vi.mock("@features/mentee/views/onboarding/PersonalInfoSection", () => ({
  default: () => <div data-testid="personal-section" />,
}));
vi.mock(
  "@features/mentee/views/onboarding/ProfessionalDetailsSection",
  () => ({
    default: () => <div data-testid="prof-section" />,
  }),
);
vi.mock(
  "@features/mentee/views/onboarding/InterestedFieldsSection",
  () => ({
    default: () => <div data-testid="fields-section" />,
  }),
);
vi.mock(
  "@features/mentee/views/onboarding/MentorshipPrefsSection",
  () => ({
    default: () => <div data-testid="prefs-section" />,
  }),
);
vi.mock("@features/mentee/views/onboarding/SocialLinksSection", () => ({
