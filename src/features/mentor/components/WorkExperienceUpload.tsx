...
interface WorkExperienceFile {
  name: string;
  size: number;
}

interface WorkExperienceUploadProps {
  files: (WorkExperienceFile | File)[];
  onChange: (files: (WorkExperienceFile | File)[], error: string | null) => void;
  error?: string;
}
