...
/**
 * @typedef {Object} ProfessionalInfoSectionProps
 * @property {{
 *   currentRole: string,
 *   industry: string,
 *   company?: string,
 ...
 *   hourlyRate: number
 * }} form
 * @property {(event: import('react').ChangeEvent<HTMLInputElement | HTMLSelectElement>) => void} onChange
 * @property {{
 *   currentRole?: boolean,
 *   industry?: boolean,
...
const ProfessionalInfoSection = forwardRef(
