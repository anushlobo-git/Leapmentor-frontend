...
const PersonalInfoSection = ({ form, onChange }) => {
  ...
  const handleFileChange = async (e) => {
    ...
    try {
      ...
      const res = await uploadMentorProfilePicture(formData, (e) => {
        ...
        <div className="flex items-start gap-6">
          ...
          <div className="flex flex-col items-center gap-2 shrink-0">
            ...
            <button
              ...
              onClick={handlePhotoClick}
              disabled={uploading}
              className={`text-xs font-semibold text-blue-900 bg-transparent border-0 p-0
            ...
            {/* ✅ Upload error */}
            {uploadErr && (
              <p className="text-[10px] text-red-500 text-center max-w-22.5 leading-tight">
                {uploadErr}
              </p>
            )}
