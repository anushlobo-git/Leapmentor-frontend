...
const SkillsSection = forwardRef<HTMLDivElement, SkillsSectionProps>(({ form, onChange, errors = {} }, ref) => {
  ...
  const removeSkill = (skill: string) => {
    onChange({
      target: {
        name: "skills",
        value: (form.skills || []).filter((s: string) => s !== skill),
      },
    });
  };
  ...
  return (
    ...
    >
      ...
      <div className="px-6 py-5">
        {/* S6853 Fixed: Associated the form label with the text input control */}
        <label
          htmlFor="core-skills-input"
