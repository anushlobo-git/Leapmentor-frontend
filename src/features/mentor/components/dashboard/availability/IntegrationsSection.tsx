...
import { getGoogleCalendarAuthUrl, disconnectGoogleCalendar } from "@features/mentor/api/mentor.api";
...
const IntegrationsSection = ({ googleCalendarConnected, onConnectionChange }: IntegrationsSectionProps) => {
