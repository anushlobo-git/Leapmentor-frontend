...
interface ReferredByProfileModalProps {
  mentor?: ReferredByMentor | null;
  onClose: () => void;
}

// ── Read-only Mentor Profile Modal ────────────────────────────
const ReferredByProfileModal = ({ mentor, onClose }: ReferredByProfileModalProps) => {
