...
import ReferredByProfileModal from "@features/mentor/components/dashboard/requests/ReferredByProfileModal";
...
interface RequestCardRequest {
  ...
  message?: string;
  selectedSlots?: RequestSlot[];
  confirmedSlot?: RequestSlot;
  status: string;
  requestedAt: string;
...
// ── Slots Detail Modal ────────────────────────────────────────
const SlotsModal = ({ request, onClose }: { request: RequestCardRequest; onClose: () => void }) => {
  const {
    mentee,
    selectedSlots = [],
    confirmedSlot,
...
// ── Main Request Card ─────────────────────────────────────────
const RequestCard = ({ request, onViewProfile }: { request: RequestCardRequest; onViewProfile: (request: RequestCardRequest) => void }) => {
