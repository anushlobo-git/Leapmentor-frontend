...
import RequestActionModal from "@features/mentor/components/dashboard/requests/RequestActionModal";
import ReferModal from "@features/mentor/components/dashboard/requests/ReferModal";
...
interface MenteeRequest {
  _id: string;
  mentee?: { name?: string };
  selectedSlots?: MenteeRequestSlot[];
  message?: string;
...
const MenteeProfileModal = ({ request, onClose, onUpdate }: MenteeProfileModalProps) => {
  // null | 'accepted' | 'rejected' | 'refer'
  const [loading, setLoading] = useState<string | null>(null);
  const [actionModal, setActionModal] = useState<{ type: "accepted" | "rejected"; mentee?: string } | null>(null);
        ...
        <div className="px-6 pb-6 space-y-5">
          ...
          <div>
            ...
            <div className="space-y-2">
              {slots.map((slot: MenteeRequestSlot) => (
