...
const selectClass = (hasError: boolean | undefined, hasValue: boolean) => {
  const baseClass =
  ...
  const stateClass = hasError
    ...
    : "border-slate-300 focus:border-blue-400 focus:ring-blue-100";
  const valueClass = hasValue ? "text-slate-800" : "text-slate-400";

  return `${baseClass} ${stateClass} ${valueClass}`;
};
...
interface ProfessionalInfoErrors {
  currentRole?: boolean;
  industry?: boolean;
...
const ProfessionalInfoSection = forwardRef<HTMLDivElement, ProfessionalInfoSectionProps>(
  ({ form, onChange, errors = {} }, ref) => {
    return (
      <div
        ref={ref}
          ...
          <div className="grid grid-cols-2 gap-4">
            ...
            <div className="col-span-2">
              <label
                ...
                className="block text-xs font-semibold text-slate-500 mb-2"
              >
                <span>Session Rate (Leap Points)</span>
