...
} from "@features/mentor/models/mentorOnboardingSlice";
...
vi.mock("@features/mentor/models/mentorOnboardingSlice", () => ({
...
vi.mock("@features/mentor/views/onboarding/PersonalInfoSection", () => ({
...
vi.mock(
  "@features/mentor/views/onboarding/ProfessionalInfoSection",
  () => ({
    default: ({ form, onChange, errors }) => (
...
vi.mock("@features/mentor/views/onboarding/SkillsSection", () => ({
...
vi.mock("@features/mentor/views/onboarding/PreferencesSection", () => ({
...
vi.mock("@features/mentor/views/onboarding/SocialLinksSection", () => ({
  default: ({ form, onChange }) => (
