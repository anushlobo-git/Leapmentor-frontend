...
interface BusyConflictModalProps {
  conflicts: Conflict[];
  onConfirm: () => void;
  onCancel: () => void;
}

const BusyConflictModal = ({ conflicts, onConfirm, onCancel }: BusyConflictModalProps) => (
...
const AvailabilityTab = () => {
  ...
  if (loading) {
    return <Loader minHeight={300} message="Loading availability..." />;
  }
