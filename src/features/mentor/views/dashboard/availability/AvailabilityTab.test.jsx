...
vi.mock("@features/mentor/presenters/useAvailability", () => ({
  default: vi.fn(),
}));

vi.mock(
  "@features/mentor/views/dashboard/availability/CalendarAvailabilitySection",
  () => ({
    default: ({
      specificDates,
      setSpecificDates,
...
vi.mock(
  "@features/mentor/views/dashboard/availability/TimezoneDurationSection",
  () => ({
    default: () => (
...
vi.mock(
  "@features/mentor/views/dashboard/availability/IntegrationsSection",
  () => ({
