...
vi.mock("@features/connects/presenters/useOngoingConnects", () => ({
  default: vi.fn(() => ({ ongoingConnects: [] })),
}));

vi.mock("@features/support/models/support.api", () => ({
  sendSupportMessage: vi.fn(),
  sendAiChatMessage: vi.fn(),
}));

// Mock hooks & configs
vi.mock("@features/mentor/presenters/useMentorDashboard", () => ({
  default: vi.fn(),
}));

vi.mock("@features/mentor/models/mentorNavItems", () => ({
