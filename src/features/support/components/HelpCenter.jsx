...
// Extracted so the email / subject / message fields (previously three
// near-identical style blocks + focus/blur handlers) share one definition.
...
function FormField({ as = "input", style, ...rest }) {
  const Tag = as;
  return (
    <Tag
      {...rest}
