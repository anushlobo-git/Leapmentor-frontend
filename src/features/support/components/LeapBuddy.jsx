...
import { sendAiChatMessage, sendSupportMessage } from "@features/support/api/support.api";
...
export default function LeapBuddy({ role = "mentee", user = null, profile = null }) {
  ...
  const sendMessage = async (text) => {
    ...
    try {
  const { data } = await sendAiChatMessage({ messages: newHistory, systemPrompt: buildSystemPrompt(role, userContext) });
