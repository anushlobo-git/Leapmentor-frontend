...
import { formatSlotDate, formatSlotTime } from "@features/sessions/presenters/sessionFormat";

export type SessionPersonKey = "mentor" | "mentee";
export type SessionCardSize = "default" | "compact";

interface SessionCardSlot {
  date?: string;
  startTime?: string;
  endTime?: string;
}

export interface SessionCardRequest {
  _id?: string;
  status?: string;
  confirmedSlot?: SessionCardSlot | null;
...
interface SessionCardProps {
  request: SessionCardRequest;
  index: number;
  navigate: NavigateFunction;
  personKey: SessionPersonKey;
  size?: SessionCardSize;
  accentPalette: string[];
}

const StatusPill = ({ isOngoing }: StatusPillProps) => (
  <span
