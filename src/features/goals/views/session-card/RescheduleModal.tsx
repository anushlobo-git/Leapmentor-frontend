...
import { formatTime, isActive } from "@features/goals/presenters/sessionCardUtils";
...
interface RescheduleModalProps {
  ...
  onConfirm: (slotIndex: number, newSlot: { day?: string; date?: string; startTime?: string; endTime?: string }) => void;
  onClose: () => void;
  saving: boolean;
}

const RescheduleModal = ({ slotIndex, connectRequestId, existingSlots, onConfirm, onClose, saving }: RescheduleModalProps) => {
  ...
  const [selectedNewSlot, setSelectedNewSlot] = useState<(SelectedSlot & { day?: string }) | null>(null);
        ...
        <div className="flex-1 overflow-y-auto px-6 py-4 flex flex-col gap-4">
          ...
          <div>
            ...
            <div className="flex gap-2 flex-wrap">
              {sessionDurations.map((dur: number) => (
                <button
                  key={dur}
                  type="button"
