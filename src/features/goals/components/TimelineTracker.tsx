...
const getProgress = (startDate: string | undefined, endDate: string | undefined) => {
...
const getDaysLeftMessage = (daysLeft: number) => {
...
const TimelineDisplay = ({ goal, progress, daysLeft }: { goal: TimelineGoal; progress: number; daysLeft: number | null }) => (
  <div className="flex flex-col gap-3">
    {/* Date labels */}
