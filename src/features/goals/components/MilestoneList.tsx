...
const getDueBadgeClass = (isCompleted: boolean | undefined, overdue: boolean | undefined | string) => {
...
const MilestoneProgress = ({ completed, total }: { completed: number; total: number }) => {
...
interface AddMilestoneFormProps {
  onAdd: (data: { title: string }) => Promise<void>;
  onCancel: () => void;
  saving: boolean;
}

const AddMilestoneForm = ({ onAdd, onCancel, saving }: AddMilestoneFormProps) => {
...
const DeleteMilestoneModal = ({ milestone, onConfirm, onCancel }: DeleteMilestoneModalProps) => (
...
const MilestoneRow = ({ milestone, onToggle, onRequestDelete }: MilestoneRowProps) => {
...
interface MilestoneListProps {
  ...
  saving: boolean;
  onAdd: (goalId: string, data: { title: string }) => Promise<{ success?: boolean } | undefined>;
  onToggle: (id: string, isCompleted: boolean) => void;
