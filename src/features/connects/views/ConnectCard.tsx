...
const formatSlot = (slot: ConnectSlot | undefined) => {
  if (!slot) return null;
...
const Avatar = ({ name, picture, isCompleted }: { name?: string; picture?: string; isCompleted?: boolean }) => {
