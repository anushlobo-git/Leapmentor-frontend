...
const getDropzoneClass = (isDragOver: boolean, hasFile: boolean) => {
  const base =
...
interface PrivateUploadModalProps {
...
const PrivateUploadModal = ({ onUpload, uploading, onClose }: PrivateUploadModalProps) => {
