...
import type { PrivateNote } from "@features/shared-dashboard/components/tabs/private-notes/NoteListItem";

interface NotepadEditorProps {
  note?: PrivateNote | null;
  onSave: (noteId: string | undefined, title: string, content: string) => Promise<{ success?: boolean } | undefined>;
...
// ── Notepad Editor ────────────────────────────────────────────
const NotepadEditor = ({ note, onSave, onDelete, onClose, saving }: NotepadEditorProps) => {
