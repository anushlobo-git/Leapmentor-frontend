...
const PrivateFileCard = ({ note, onDelete }) => {
  ...
  const handleDownload = async () => {
    logger.info("Downloading private note file", {
      fileId: note._id,
    ...
    try {
      ...
      logger.warn(
        "Private note download failed, falling back to browser open",
        { fileId: note._id, fileUrl: note.fileUrl, error: err?.message },
      );
