...
import useReportComplaint from "@features/reports/hooks/useReportComplaint";
import {
  selectConnectId,
  selectViewerRole,
} from "@features/shared-dashboard/store/sharedDashboardSlice";
import { validateScreenshotFile } from "@lib/validation/schemas";
...
const ReportModal = ({ onClose, onSuccess }: ReportModalProps) => {
  ...
  ].reduce((acc: typeof BASE_COMPLAINT_TYPES, ct) => {
