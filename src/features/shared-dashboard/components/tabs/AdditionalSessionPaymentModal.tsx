...
interface AdditionalSessionSlot {
  date?: string;
  day?: string;
  startTime?: string;
  endTime?: string;
...
interface AdditionalSessionConnect {
  _id?: string;
  mentorProfile?: { hourlyRate?: number };
  mentor?: { name?: string };
}

interface AdditionalSessionPaymentModalProps {
  connect?: AdditionalSessionConnect;
  slot?: AdditionalSessionSlot;
  slotId?: string;
  onClose: () => void;
  onSuccess: () => void;
}
