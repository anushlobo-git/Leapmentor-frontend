...
export const groupNotesByDay = (notes: NoteFile[]) => {
  const groupedItems = [];
...
export const downloadNoteFile = async (note: NoteFile, label: string) => {
...
interface NoteDateSeparatorProps {
  dateStr?: string;
}

export const NoteDateSeparator = ({ dateStr }: NoteDateSeparatorProps) => (
...
export interface FileTypeBadgeCfg {
  bg?: string;
  border?: string;
  text?: string;
  icon?: string;
...
export const FileTypeBadge = ({ cfg }: { cfg: FileTypeBadgeCfg }) => (
  <div
...
interface NotesLoadingSkeletonsProps {
  gridClassName: string;
}

export const NotesLoadingSkeletons = ({ gridClassName }: NotesLoadingSkeletonsProps) => (
