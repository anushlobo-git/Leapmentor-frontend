...
vi.mock("@features/goals/presenters/useGoals", () => ({
  default: vi.fn(),
}));
...
vi.mock("@features/reports/presenters/useReport", () => ({
  default: vi.fn(),
}));
...
vi.mock("@features/goals/views/SessionCard", () => ({
  default: ({
    slot,
    onSetLink,
    onMarkComplete,
...
vi.mock("@features/shared-dashboard/views/tabs/FeedbackModal", () => ({
