...
vi.mock("@features/notes/presenters/useNotes", () => ({
  default: vi.fn(),
}));

// Mock shared components tab layouts
vi.mock("@features/shared-dashboard/views/tabs/notesTabShared", () => ({
...
vi.mock(
  "@features/shared-dashboard/views/tabs/private-notes/PrivateUploadModal",
  () => ({
...
vi.mock(
  "@features/shared-dashboard/views/tabs/private-notes/PrivateFileCard",
  () => ({
