...
import PrivateUploadModal from "@features/shared-dashboard/views/tabs/private-notes/PrivateUploadModal";
import PrivateFileCard from "@features/shared-dashboard/views/tabs/private-notes/PrivateFileCard";
...
const PrivateFilesSection = () => {
  ...
  const handleUpload = async (file: File, title: string) => uploadNote(file, title, true);
  const handleDelete = async (noteId: string) => deleteNote(noteId, true);
