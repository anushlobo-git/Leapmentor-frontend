...
import usePrivateNotes from "@features/notes/presenters/usePrivateNotes";
import NotepadEditor from "@features/shared-dashboard/views/tabs/private-notes/NotepadEditor";
import NoteListItem from "@features/shared-dashboard/views/tabs/private-notes/NoteListItem";
...
// ── Notepad Section ───────────────────────────────────────────
const NotepadSection = ({ connectId, isCompleted }: NotepadSectionProps) => {
  ...
  const handleSave = async (noteId: string | undefined, title: string, content: string) => {
