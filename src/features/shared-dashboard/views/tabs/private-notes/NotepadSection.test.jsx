...
vi.mock("@features/notes/presenters/usePrivateNotes", () => ({
  default: vi.fn(),
}));

// Mock subcomponents to track parameter handoffs cleanly
vi.mock(
  "@features/shared-dashboard/views/tabs/private-notes/NotepadEditor",
  () => ({
...
vi.mock(
  "@features/shared-dashboard/views/tabs/private-notes/NoteListItem",
  () => ({
