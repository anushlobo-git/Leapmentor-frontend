...
import SharedTopbar from "@features/shared-dashboard/views/SharedTopbar";
import SharedSidebar from "@features/shared-dashboard/views/SharedSidebar";
import SharedHomeTab from "@features/shared-dashboard/views/tabs/SharedHomeTab";
import SharedChatTab from "@features/shared-dashboard/views/tabs/SharedChatTab";
import SharedGoalsTab from "@features/shared-dashboard/views/tabs/SharedGoalsTab";
import SharedNotesTab from "@features/shared-dashboard/views/tabs/SharedNotesTab";
import SharedAdditionalSessionTab from "@features/shared-dashboard/views/tabs/SharedAdditionalSessionTab";
...
const SharedDashboardLayout = () => {
  ...
  useSocketToast(undefined, undefined);
