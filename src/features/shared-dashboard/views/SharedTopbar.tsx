...
// src/components/shared-dashboard/SharedTopbar.tsx
...
const SharedTopbar = ({ viewerRole, onMenuToggle, onLogoClick }: SharedTopbarProps) => {
  ...
  return (
    <header style={{
      ...
      <button
        ...
        onMouseEnter={(event: MouseEvent<HTMLButtonElement>) => event.currentTarget.style.backgroundColor = "#1e40af"}
        onMouseLeave={(event: MouseEvent<HTMLButtonElement>) => event.currentTarget.style.backgroundColor = "#1e3a8a"}
      >
