...
interface SharedSidebarProps extends SidebarContentProps {
  isOpen: boolean;
}
...
const SidebarContent = ({ activeTab, setActiveTab, onClose, viewerRole }: SidebarContentProps) => (
...
const SharedSidebar = ({ activeTab, setActiveTab, isOpen, onClose, viewerRole }: SharedSidebarProps) => {
  useEffect(() => {
