...
vi.mock("@features/shared-dashboard/views/tabs/SharedHomeTab", () => ({
  default: () => <div data-testid="shared-home-tab">home</div>,
}));

vi.mock("@features/shared-dashboard/views/tabs/SharedChatTab", () => ({
  default: () => <div data-testid="shared-chat-tab">chat</div>,
}));

vi.mock("@features/shared-dashboard/views/tabs/SharedGoalsTab", () => ({
  default: () => <div data-testid="shared-goals-tab">goals</div>,
}));

vi.mock("@features/shared-dashboard/views/tabs/SharedNotesTab", () => ({
  default: () => <div data-testid="shared-notes-tab">notes</div>,
}));

vi.mock(
  "@features/shared-dashboard/views/tabs/SharedAdditionalSessionTab",
  () => ({
