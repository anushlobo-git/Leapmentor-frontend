...
const COMM_EMOJI: Record<string, string> = {
  "Video Call": "🎥",
  Chat: "💬",
  Email: "✉️",
  "Phone Call": "📞",
...
const HeroCard = ({ user, profile, config, onEdit }: HeroCardProps) => {
...
const ProfessionalInfoCard = ({ profile, fields }: ProfessionalInfoCardProps) => (
...
const TagsCard = ({ profile, sections }: TagsCardProps) => (
  <div className="bg-white rounded-2xl border border-slate-100 shadow-sm p-5">
...
const MentorshipPrefsCard = ({ profile, commLabelMap }: MentorshipPrefsCardProps) => {
