...
// src/features/admin/components/verifications/VerificationIcons.tsx
...
export const IconCheck = ({ size = 16 }: SizedIconProps) => (
  <svg
    width={size}
    height={size}
    viewBox="0 0 24 24"
...
export const IconX = ({ size = 16 }: SizedIconProps) => (
  <svg
    width={size}
    height={size}
    viewBox="0 0 24 24"
