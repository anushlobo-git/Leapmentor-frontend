...
export default function AdminSupportMessages() {
  ...
  // ── FIX FOR S3358: Extract nested ternary layout logic to independent statements ──
  let mainContent;
  ...
  if (loading) {
    ...
    mainContent = (
      <div style={{ textAlign: "center", padding: "60px 0", color: "#94a3b8" }}>
        {/* FIX FOR S7735: Inverted negated condition from (!== all) to positive evaluation */}
    ...
    mainContent = (
      <div style={{ display: "flex", flexDirection: "column", gap: 10 }}>
        {filtered.map((msg) => {
          ...
          const handleToggleExpand = () => setExpanded(isOpen ? null : msg._id);
          ...
          return (
            ...
            >
              {/* FIX: Use a native <button> instead of div+role="button" (Sonar: prefer input/button over ARIA role on non-interactive element). Native button gives keyboard support (Enter/Space) and focus styling for free, so onKeyDown/role/tabIndex are no longer needed. */}
              <button
                type="button"
