...
// src/features/admin/components/payments/RevenuePanel.tsx
import RevenueChart from "@features/admin/views/payments/RevenueChart";
import { FONT, MONO } from "@features/admin/models/payments.constants";
...
const RevenuePanel = ({ chartData, loadingChart }: RevenuePanelProps) => (
  <div
