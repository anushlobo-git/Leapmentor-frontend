...
// src/features/admin/components/payments/TransactionsTable.tsx
import type { FocusEvent, MouseEvent, ReactNode } from "react";
import Avatar from "@features/admin/views/payments/Avatar";
import TypeBadge from "@features/admin/views/payments/TypeBadge";
import TxStatusBadge from "@features/admin/views/payments/TxStatusBadge";
import {
  FONT,
  MONO,
  SKELETON_ROW_IDS,
...
const renderTableBody = ({
  loading,
  transactions,
}: Pick<TransactionsTableProps, "loading" | "transactions">): ReactNode => {
  if (loading) {
    ...
    >
      ...
      <td className="px-5 py-4">
        <div className="flex items-center gap-2.5">
          <Avatar name={transaction.user?.name} />
          <div>
            <p
      ...
      <td className="px-5 py-4">
        <span
          ...
          style={{ fontFamily: MONO, fontWeight: 500 }}
        >
          {transaction.amount == null ? "" : formatDecimal(transaction.amount)}
        </span>
      </td>
      <td className="px-5 py-4">
