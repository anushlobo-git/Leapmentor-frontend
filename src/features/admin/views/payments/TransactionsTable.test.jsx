...
vi.mock("@features/admin/views/payments/Avatar", () => ({
  default: ({ name }) => <span data-testid="mock-avatar">{name}</span>,
}));

vi.mock("@features/admin/views/payments/TypeBadge", () => ({
  default: ({ type }) => <span data-testid="mock-type-badge">{type}</span>,
}));

vi.mock("@features/admin/views/payments/TxStatusBadge", () => ({
  default: ({ status }) => (
...
vi.mock("@features/admin/models/payments.constants", () => ({
  FONT: "sans-serif",
  MONO: "monospace",
