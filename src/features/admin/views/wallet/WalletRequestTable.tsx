...
// src/features/admin/components/wallet/WalletRequestTable.tsx
...
interface RequestRowProps {
  req: WalletRequest;
  onApprove: (requestId: string | undefined) => void;
  onReject: (requestId: string | undefined) => void;
  actionLoading?: string | null;
  onViewHistory: (mentee: WalletMentee | null | undefined) => void;
}
...
export const Toast = ({ toast }: ToastProps) => {
  ...
  const c = toast.type ? colors[toast.type] : colors.success;
  return (
    <div
