...
vi.mock("@features/admin/presenters/usePaymentsData", () => ({
...
vi.mock("@features/admin/views/payments/Toast", () => ({
  default: ({ toast }) =>
    toast ? <div data-testid="toast">{toast.msg}</div> : null,
}));

vi.mock("@features/admin/views/payments/PaymentsStatCards", () => ({
  default: ({ stats }) => (
...
vi.mock("@features/admin/views/payments/RevenuePanel", () => ({
...
vi.mock("@features/admin/views/payments/TransactionsTable", () => ({
  default: ({
    transactions,
    loading,
    pagination,
