...
import {
  ...
  IconClose,
  IconExternalLink,
} from "@features/admin/views/verifications/VerificationIcons";
...
interface MentorProfile {
  ...
  bio?: string;
  skills?: string[];
  resumeDocument?: MentorDocument;
  workExperienceDocuments?: MentorDocument[];
}
...
interface DetailDrawerProps {
  mentor?: MentorVerification | null;
  onClose: () => void;
  onVerify: (mentorProfileId?: string) => void;
  verifying: boolean;
}
...
// ── Doc Preview Card ─────────────────────────────────────
const DocCard = ({ label, url, icon }: { label: string; url?: string; icon?: ReactNode }) => {
  if (!url) return null;
...
// DETAIL DRAWER
// ══════════════════════════════════════════════════════════
const DetailDrawer = ({ mentor, onClose, onVerify, verifying }: DetailDrawerProps) => {
