...
import AdminEngagements from "@features/admin/views/AdminEngagements";
import {
  getEngagementStats,
  getEngagements,
...
vi.mock("@features/admin/views/common/StatCard", () => ({
  default: ({ label, value }) => (
...
vi.mock("@features/admin/views/common/StatusBadge", () => ({
