...
- `main.tsx` - application bootstrap, store injection, global error hooks.
...
- `store/` - root Redux store composition only (`index.ts`). Feature slices live inside their feature.
